...
function MoveDoer:onBind(target)
    assert(self.m_Owner == nil, "MoveDoer:onBind() the MoveDoer has already bound a target.")
...
function MoveDoer:onUnbind()
    assert(self.m_Owner, "MoveDoer:unbind() the component has not bound a target.")
